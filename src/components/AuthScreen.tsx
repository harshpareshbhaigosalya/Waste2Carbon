...
export const AuthScreen: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-[#fcfbf7] flex flex-col justify-center items-center p-4 selection:bg-emerald-600 selection:text-white relative">
      {/* Background ambient golden-emerald decorative shapes */}
      <div className="absolute top-1/4 -left-20 w-96 h-96 bg-amber-200/40 rounded-full blur-3xl pointer-events-none" />
      <div className="absolute bottom-1/4 -right-20 w-96 h-96 bg-emerald-200/40 rounded-full blur-3xl pointer-events-none" />

      <div className="w-full max-w-md relative z-10 space-y-6">
        {/* Brand Header */}
        <div className="text-center space-y-2">
          <div className="inline-flex items-center justify-center w-14 h-14 rounded-2xl bg-gradient-to-tr from-emerald-700 to-emerald-500 text-white shadow-xl shadow-emerald-700/20 font-black mb-2 border-2 border-amber-300">
        ...
        {/* Auth Card */}
        <div className="bg-white border-2 border-amber-200/90 rounded-3xl p-6 sm:p-8 shadow-xl space-y-5">
          {/* Tabs */}
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  required
                  className="w-full bg-slate-50 border border-slate-300 rounded-xl pl-10 pr-4 py-2.5 text-xs text-slate-900 focus:outline-none focus:border-emerald-600 focus:bg-white transition"
                />
              </div>
            </div>
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full bg-gradient-to-r from-emerald-700 to-emerald-600 hover:from-emerald-800 hover:to-emerald-700 text-white font-black text-xs py-3 rounded-xl shadow-lg transition flex items-center justify-center gap-2 cursor-pointer disabled:opacity-50"
            >
              {isLoading ? (
          ...
          <div className="border-t border-slate-200 pt-3 text-center space-y-1">
            ...
            <div className="flex flex-wrap items-center justify-center gap-2 text-[11px]">
              <button
                ...
                className="bg-amber-100 hover:bg-amber-200 text-amber-900 font-bold px-2.5 py-1 rounded-lg border border-amber-300 transition"
              >
      ...
      {verificationModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-emerald-950/40 backdrop-blur-sm">
          <div className="relative w-full max-w-sm bg-white border-2 border-emerald-300 rounded-3xl p-6 shadow-2xl space-y-4 text-center">
